...
# note that the next line of code is equivalent to the one above.  It takes more effort but can be easier to read the one above when you haven't looked at the code in a while,
spread(trawl_abiotic, nafo_div, depth) 

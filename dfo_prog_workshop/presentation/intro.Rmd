...
1. We will use the following dataset *WhitefishMB {FSAdata}*  
...
In the cohort model we have been using, age 1 individuals were being forcefully created  
...
fx <- c(rep(0, 2), 0.1, 0.15, 0.25, 0.6, 0.9, 0.9, 0.85, 0.7)
## step 5: 

...
head(df)
df$weight
#df_1617 <- read_csv('data/capelin_condition_maturation_v1.csv')
#glimpse(df_1617)
...
## A tidyverse review: ggplot2 - scatterplot  {.build}
...
- Work with a subset of trawl (say 2008 onwards)
- Take code and modify for trawl
